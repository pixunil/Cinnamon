...
SCROLL_METHOD = {
    _("Disabled"): "disabled",
    _("Edge Scrolling"): "edge-scrolling",
    _("Two-finger scrolling"): "two-finger-scrolling"
}
...
class Module:
    ...
    def on_module_selected(self, switch_container):
        if not self.loaded:
            ...
            section.add_indented(GSettingsIntComboBox(_("Two-finger click emulation:"), "org.cinnamon.settings-daemon.peripherals.touchpad", "two-finger-click", "org.cinnamon.settings-daemon.peripherals.touchpad/touchpad-enabled", BUTTON_LIST))
            section.add_indented(GSettingsIntComboBox(_("Three-finger click emulation:"), "org.cinnamon.settings-daemon.peripherals.touchpad", "three-finger-click", "org.cinnamon.settings-daemon.peripherals.touchpad/touchpad-enabled", BUTTON_LIST))
